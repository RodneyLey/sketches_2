...
int LED=5; // LED is connected to PWM pin 3 of arduino.
...
void loop(){
  ...
  if(LDRvalue<=200){      //when the value of LDR goes below 100 in the room, led will turn ON.
    for(i=0;i<=255;i++){  //increasing the brightness of led, PWM range is from (0-255)
      ...
      delay(50); //60seconds or 60000/255=235 
    }
